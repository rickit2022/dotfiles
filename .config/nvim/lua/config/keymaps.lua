...
end, { desc = "Telescope live_grep", noremap = true, silent = true})
vim.keymap.set('n', '<leader>gs', function()
  require('telescope.builtin').grep_string()
end, { desc = "Telescope grep_string (not using ripgrep)", noremap = true, silent = true})
vim.keymap.set('n', '<leader>cb', function()
  require('telescope.builtin').current_buffer_fuzzy_find()
end, { desc = "Telescope current_buffer_fzf", noremap = true, silent = true})
...
------ Black-hole delete and 'd', 'e' remap 
vim.keymap.set({'n','v'}, 'd', '"_d', { desc = 'Delete without yanking', noremap = true,})
vim.keymap.set({'n','v'}, 'D', '"_D', { desc = 'Delete until end of line'})
